...
var MovimentoCtReceberRouter = require('./routes/movimentoctReceber')
var tituloreceberController = require('./routes/tituloreceber')
...
app.use('/contareceber', MovimentoCtReceberRouter)
app.use('/tituloreceber', tituloreceberController)
